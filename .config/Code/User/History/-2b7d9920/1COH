...
fastfetch --logo /home/user/.config/fastfetch/archascii.txt --color-keys magenta --title-color-user cyan --title-color-host magenta --logo-padding-top 1 --logo-padding-right 2 --separator-length 62
